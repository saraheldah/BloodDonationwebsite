...
INSERT INTO `blood-donner`.`Country` (`ID`,  `CountryName`) VALUES
(1,  'Afghanistan'),
(2,  'Aland Islands'),
(3, 'Albania'),
(4, 'Algeria'),
...
INSERT INTO `blood-donner`.`BloodType` (`ID`,`Name`,`RareGrade`) VALUES
(1,'O+',2),
(2,'O-',1),
(3,'A+',2),
(4,'A-',4),
...
INSERT INTO `blood-donner`.`BloodTypeCompatibilty` (  `BloodTypeID`,`CompatibleBloodTypeID`) VALUES
(1,1),
(1,2),
(2,2),
(3,1),
...
INSERT INTO `blood-donner`.`USER` ( `Fname`,`Lname`, `DOB`,  `Gender`,`Phone`,`Email`,  `Password`,`IsDonor`,`Role`,  `BloodTypeId`,`Country`) VALUES
 ('Samy','kalem','1990/3/2','male','12345678','Samy.Kalem@hotmail.com','$@my123',0,1,2,'Lebanon');



INSERT INTO `blood-donner`.`City` (  `CityName`, `CountryId`) VALUES
('Akkar',125),
('Aley',125),
('Baabda',125),
('Baalbeck',125),
...
INSERT INTO `blood-donner`.`USER` ( `Fname`,`Lname`, `DOB`,  `Gender`,`Phone`,`Email`,  `Password`,`IsDonor`,`Role`,  `BloodTypeId`,`CountryId`,`CityId`) VALUES
 ...
 INSERT INTO `blood-donner`.`USER` ( `Fname`,`Lname`, `DOB`,  `Gender`,`Phone`,`Email`,  `Password`,`IsDonor`,`Role`,  `BloodTypeId`,`CountryId`,`CityId`) VALUES
 ('saeed','Eldah','1990/3/2',0,'12345678','Ss.eldah@hotmail.com','$@my123',0,1,2,125,7);

 INSERT INTO `blood-donner`.`USER` ( `Fname`,`Lname`, `DOB`,  `Gender`,`Phone`,`Email`,  `Password`,`IsDonor`,`Role`,  `BloodTypeId`,`CountryId`,`CityId`) VALUES
 ('Sarah','Eldah','1999/3/2',1,'12345678','sarah.eldah@gmail.com','$@r@123',0,1,3,125,8);
